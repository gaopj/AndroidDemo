...
import gpj.com.imageloaderdemo.loader.ImageLoader;

import static gpj.com.imageloaderdemo.Utils.dp2px;
import static gpj.com.imageloaderdemo.Utils.getScreenMetrics;
import static gpj.com.imageloaderdemo.Utils.isWifi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageAdapter.ImageViewSetListener mImageViewSetListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initView();
        mImageLoader = ImageLoader.getInstance(MainActivity.this);
    }
    ...
    private void initView() {
        ...
        mImageViewSetListener = new ImageAdapter.ImageViewSetListener() {
            @Override
            public void bingImageView(ImageView imageView, String uri) {
        ...
        mImageAdapter = new ImageAdapter(this,mUrList,mImageViewSetListener);
        ...
        mImageGridView.setOnScrollListener(mOnScrollListener);
