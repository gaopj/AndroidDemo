package com.gpj.breakpointdownloaddemo.downloader;
...
/**
 * Created by v-pigao on 5/6/2018.
 */

public class DownLoaderManager {
    public static String FILE_PATH = Environment.getExternalStorageDirectory() + "/gpj";
    ...
    private static volatile DownLoaderManager manger;
    private  DownLoaderManager(DbHelper helper, OnProgressListener listener) {
        this.helper = helper;
     ...
     * @return
     */
    public static synchronized DownLoaderManager getInstance(DbHelper helper, OnProgressListener listener) {
        if (manger == null) {
            synchronized (DownLoaderManager.class) {
                if (manger == null) {
                    manger = new DownLoaderManager(helper, listener);
                }
            }
        }
        return manger;
